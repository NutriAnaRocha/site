/* ============================================================
   CONTA — entrar, cadastrar e recuperar senha da biblioteca de Priscila Melo · Nutricionista.
...
(function () {
  ...
  /* ---------- destino após autenticar ----------
     ?next=pagina.html tem prioridade (veio de "acessar minha biblioteca").
